...
public class WorkerThread implements Runnable
{
	...
	public void run()
	{
		try
		{
			 ...
			 * "A transmission was received: " + incomingMessage);
			 * handleMessage(incomingMessage); }
			 */
			...
			SwingUtilities.invokeLater(new Runnable()
			{
				...
				public void run()
				{
					...
					// MainWindow.scroller.setSize(MainWindow.scroller.getPreferredSize().width+50,
					// MainWindow.scroller.getPreferredSize().height);
	...
	public void handleMessage(String message)
	{
		...
		// JOptionPane.showMessageDialog(null, "Handle message got
		...
		else if (messageArray[0].equals("QUERY"))
		{
			...
			try
			{
				// JOptionPane.showMessageDialog(null, "About to try and send
				// the ArrayList.");
			...
			catch (IOException e)
			{
				...
				// sending the results back to the client.", "Error",
